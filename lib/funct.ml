...
module Make_incrementor (A : Summable) (M : Summer with type t = A.t) :
...
let increment (type a) (module A : Incrementor with type t = a) (n: a) =
  A.inc n


let apply_twice f n = f (f n)

let increment_twice (type a) (module A : Incrementor with type t = a) (n: a) =
